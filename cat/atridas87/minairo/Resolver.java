...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    public Void visitReturnStmt(Stmt.Return stmt) {
        if (currentFunction == FunctionType.NONE) {
            Minairo.error(stmt.keyword, "Can't return from top-level code.");
        }

        if (stmt.value != null) {
            if (currentFunction == FunctionType.INITIALIZER) {
                Minairo.error(stmt.keyword, "Can't return a value from an initializer.");
            }
            resolve(stmt.value);
        }
    ...
    public Void visitThisExpr(Expr.This expr) {
        if (currentClass == ClassType.NONE) {
            Minairo.error(expr.keyword, "Can't use 'this' outside of a class.");
        } else {
    ...
    public Void visitVariableExpr(Expr.Variable expr) {
        if (!scopes.isEmpty() &&
            ...
            Minairo.error(expr.name, "Can't read local variable in its own initializer.");
        }
